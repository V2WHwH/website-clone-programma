  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-5 pt-8 md:px-8">
      ...
      <article className="max-w-3xl pb-20 pt-10 md:pt-14">
        <h1 className="text-4xl leading-[1.1] md:text-5xl">Privacyverklaring</h1>
        ...
        <section className="mt-10">
          <h2 className="text-2xl">Welke gegevens we verwerken</h2>
        ...
        <section className="mt-10">
          <h2 className="text-2xl">Wat we niet doen</h2>
          <div className="mt-4 space-y-4 leading-relaxed text-zacht">
            <p>
        ...
        <section className="mt-10">
          <h2 className="text-2xl">Uw rechten</h2>
          <div className="mt-4 space-y-4 leading-relaxed text-zacht">
            <p>
