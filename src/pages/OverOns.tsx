        ...
        <div className="mt-10 grid gap-8 md:grid-cols-2">
          <Reveal className="rounded-kaart border border-lijn bg-nacht p-7">
            ...
            <p className="mt-3 leading-relaxed text-zacht">
              Ons zusterbedrijf HEREweHOLO is volledig gespecialiseerd in holografische oplossingen: holoboxen, HEREweHOLO mini's en hologramwanden. Vision2Watch is officieel verhuurpartner van HEREweHOLO en verzorgt de verhuur, levering en installatie van deze producten in Nederland; beide teams werken nauw samen en holografische projecten lopen vaak gezamenlijk.
            </p>
            <div className="mt-5">
