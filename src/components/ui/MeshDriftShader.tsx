// ShaderBackground — gebaseerd op de 21st.dev Shader Builder ("Mesh drift").
...
//   iets verlaagd zodat de beweging rustig blijft.
// Het opnemen/pauzeren gebeurt in de component zelf: hij stopt bij een
// verborgen tabblad of buiten beeld; de reduced-motion-afweging ligt bij
// de aanroeper (Achtergrond.tsx), die hem dan simpelweg niet monteert.
...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    const resizeCanvas = () => {
      // Lager dan het origineel: dpr 1 en ~1,2 Mpixel is voor deze zachte
      // mesh onzichtbaar minder, maar scheelt ruim de helft aan GPU-werk.
      const dpr = 1;
